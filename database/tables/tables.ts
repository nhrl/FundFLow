...
export const createTables = async () => {
    await db.execAsync(`
        ...
        CREATE TABLE IF NOT EXISTS expenses (expense_id INTEGER NOT NULL, name TEXT NOT NULL, amount INTEGER NOT NULL, event_id INTEGER NOT NULL, FOREIGN KEY (event_id) REFERENCES event (event_id));
        `);
}
